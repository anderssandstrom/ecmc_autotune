...
MODE_DEFINITIONS = {
    pipeline.DEFAULT_MODE: {
        ...
        "pv_labels": {
            "prefix_p": "Prefix P",
            "prefix_r": "Prefix R",
            "sp": "Torque command PV (SP) [Nm]",
            "sp_rbv": "Torque readback PV (SP_RBV) [Nm]",
        ...
        "pv_tooltips": {
            ...
            "sp": "EPICS PV that accepts the torque demand (e.g. Drv01-Trq). Enter values in Nm; they are divided by the torque scale before writing.",
            "sp_rbv": "Readback of the commanded torque (e.g. Drv01-TrqAct) converted to Nm for analysis.",
        ...
        "tuning_notes": [
            ...
            "Conceptually this is a pole-placement design for a second-order plant, matching the desired natural frequency and damping ratio.",
        ],
    },
    "csv_velocity_bode": {
    ...
    "csv_position_bode": {
        ...
        "pv_labels": {
            "prefix_p": "Prefix P",
            "prefix_r": "Prefix R",
            "sp": "Position command PV (SP) [rad]",
            "sp_rbv": "Position command readback PV (optional) [rad]",
            "act": "Position feedback PV (ACT) [rad]",
            "extra": "Extra log PVs",
        },
        "pv_tooltips": {
            "prefix_p": "First prefix segment applied before PV names (optional).",
            "prefix_r": "Second prefix segment appended after P.",
            "sp": "Position demand PV to drive during the bode sweep. Enter values in rad; commands are divided by the position scale before writing.",
            "sp_rbv": "Optional readback PV for the commanded position. Leave blank to use SP. Logged values are multiplied by the position scale.",
            "act": "Position feedback PV (PosAct) expressed in rad after scaling.",
            "extra": "Optional extra PVs to log (NAME=PV or PV). One per line.",
        },
        "time_plot": {
            "command_label": "Position command",
            "command_units": "rad",
            "response_label": "Position feedback",
            "response_units": "rad",
            "ylabel": "Command / Response",
        },
        "mechanical_hint": "Mechanical identification is disabled in closed position bode mode.",
        "tuning_notes": [
            "This mode only captures bode data for the closed position loop; no mechanical fit or PID tuning is derived.",
        ],
    },
    "csv_position_tune": {
        ...
        "pv_labels": {
            ...
            "act": "Position response PV (ACT) [rad]",
            "extra": "Extra log PVs",
        },
        "pv_tooltips": {
            "prefix_p": "First prefix segment for PV shortcuts (optional).",
            "prefix_r": "Second prefix segment appended after P.",
            "sp": "Outer-loop speed demand PV (Spd) to excite the position loop. Enter in rad/s; divided by velocity scale before writing.",
            "sp_rbv": "Velocity feedback PV (VelAct) used as the command trace. Logged values are multiplied by the velocity scale.",
            "act": "Position feedback PV (PosAct) used as the response, expressed in rad after applying the position scale.",
            "extra": "Optional extra PVs to log (NAME=PV or PV). One per line.",
        },
        "time_plot": {
            "command_label": "Speed command",

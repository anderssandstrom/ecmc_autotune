...
MODE_DEFINITIONS = {
    ...
    "csv_position_bode": {
        ...
        "pv_labels": {
            "prefix_p": "Prefix P",
            "prefix_r": "Prefix R",
            "sp": "Position command PV (SP)",
            "sp_rbv": "Position command readback PV (optional)",
            "act": "Position feedback PV (ACT)",
            "extra": "Extra log PVs",
        },
        "pv_tooltips": {
            "prefix_p": "First prefix segment applied before PV names (optional).",
            "prefix_r": "Second prefix segment appended after P.",
            "sp": "Position demand PV to drive during the bode sweep.",
            "sp_rbv": "Optional readback PV for the commanded position. Leave blank to use SP.",
            "act": "Position feedback PV (PosAct) expressed in engineering units.",
            "extra": "Optional extra PVs to log (NAME=PV or PV). One per line.",
        },
        "time_plot": {
